...
export class CarouselComponent implements OnInit {
  top5Apartments: Apartment[] = [{
    ...
    name: 'Căn số 4',
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/casem4-a667f.appspot.com/o/Miahouse01.jpg?alt=media&token=b1bde63d-d9e0-4868-b9a0-f47c954ec9ce',
    address: 'Số 1 ngõ 2 đường 3',
    price: '1000',
    description: 'Some thing to say but can not say',
    bethRoom: '3',
    ...
    name: 'Căn số 5',
    imageUrl: 'https://firebasestorage.googleapis.com/v0/b/casem4-a667f.appspot.com/o/woodendream01.jpg?alt=media&token=7d71945d-9360-4114-9746-ec04b92e3268',
    address: 'Số 1 ngõ 2 đường 3',
    price: '1000',
    description: 'Some thing to say but can not say',
    bethRoom: '3',
